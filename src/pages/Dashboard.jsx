      ...
      <div className="bg-[#9538E2] py-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center mb-4 space-y-2 sm:space-y-0 sm:space-x-4">
          <button
            ...
            className={`py-2 px-4 rounded-xl font-semibold ${activeTab === "Cart" ? "bg-gray-200" : "bg-[#9538E2] text-white"}`}
          >
            Cart
          </button>
          <button
            onClick={() => handleTabSwitch("Wishlist")}
            className={`py-2 px-4 rounded-xl font-semibold ${activeTab === "Wishlist" ? "bg-gray-200" : "bg-[#9538E2] text-white"}`}
          >
            Wishlist
          </button>
        </div>
        ...
        <div>
            ...
            {sortedCartItems.map((item) => (
              <div key={item.product_id} className="flex flex-col md:flex-row justify-between items-start md:items-center p-4 bg-white shadow-lg rounded-lg">
                <div className="flex flex-col md:flex-row items-start space-x-0 md:space-x-4 w-full">
                  <img src={item.product_image} alt={item.product_title} className="w-full md:w-24 h-24 object-cover rounded-md" />
                  <div>
          ...
          <div className="mt-4 text-center md:text-right">
            ...
            <button
              ...
              className={`mt-4 py-2 px-6 rounded-lg font-semibold ${totalCartPrice === 0 ? "bg-gray-400" : "bg-green-500 hover:bg-green-600 text-white"}`}
            >
              Purchase
            </button>
          </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 sm:p-0">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center w-full sm:w-3/4 md:w-1/2 lg:w-1/3">
            <img src="https://i.ibb.co.com/WHq3m1N/Group.png" alt="" className="text-center mx-auto" />
